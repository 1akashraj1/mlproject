...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info('Train and test data split starts')

            train_data,test_data = train_test_split(df,test_size=0.2,random_state=36)
            ...
            logging.info('Data Ingestion and split completed')
...
if __name__ == '__main__':
    ...
    score = model_trainer.initiate_model_trainier(train_arr,test_arr)
    print(score)